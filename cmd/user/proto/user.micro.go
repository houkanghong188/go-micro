...
func (c *userService) Show(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
...
func (c *userService) Closure(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "User.closure", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *userHandler) Show(ctx context.Context, in *Request, out *Response) error {
